...
| Known-place context | Dedicated phone location | Dedicated phone location | Dedicated phone location | Deferred; no IP/MAC workaround |
...
Application totals are device-scoped by default. Public IP and MAC-address tracking are not used as substitutes for a phone location or usage collector.
